    ...
    public String getLetterList(Model model, Page page){
        ...
        if(conversationList !=null){
            for(Message message : conversationList){
                ...
                map.put("unreadCount",messageService.findLetterUnreadCount(hostHolder.getUser().getId(),
                        message.getConversationId()));
                int targetId = message.getId() == message.getFromId() ? message.getToId() : message.getFromId();
